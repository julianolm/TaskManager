...
def test_search_task_bad_request():
    event = {
        "path": '/search',
...
def test_map_task_bad_request():
    event = {
        "path": '/map',
        "body": f'{{"taskid": "TSK-9831", "dataset": "{input_csv}"}}',
        "httpMethod": "POST"
    }
    context = {}
...
def test_delete_task_success():
    ...
    response = lambda_handler(event, context)
    # print(response)
    print_csv(json.loads(response['body'])['dataset'])

def test_delete_task_bad_request():
    event = {
        "path": '/delete',
        "body": f'{{"taskid": "TSK-9831", "dataset": "{input_csv}"}}',
        "httpMethod": "POST"
